...
namespace Rozdzial11_zad12
{
    class Program
    {
        ...
        {
            Console.WriteLine("* Write a program, which calculates the value of a given numeral expression given as a string. The numeral expression consists of:");
            /*
